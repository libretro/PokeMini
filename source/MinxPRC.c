...
{
	POKELOADSS_START(1+32);
	POKELOADSS_STREAM_8(StallCPU);
	POKELOADSS_STREAM_32(MinxPRC.PRCCnt);
	POKELOADSS_STREAM_32(MinxPRC.PRCBGBase);
	POKELOADSS_STREAM_32(MinxPRC.PRCSprBase);
	POKELOADSS_STREAM_8(MinxPRC.PRCMode);
	POKELOADSS_STREAM_8(MinxPRC.PRCRateMatch);
	POKELOADSS_STREAM_8(MinxPRC.PRCMapPX);
	POKELOADSS_STREAM_8(MinxPRC.PRCMapPY);
	POKELOADSS_STREAM_8(MinxPRC.PRCMapTW);
	POKELOADSS_STREAM_8(MinxPRC.PRCMapTH);
...
{
	POKESAVESS_STREAM_START(1+32);
	POKESAVESS_STREAM_8(StallCPU);
	POKESAVESS_STREAM_32(MinxPRC.PRCCnt);
	POKESAVESS_STREAM_32(MinxPRC.PRCBGBase);
	POKESAVESS_STREAM_32(MinxPRC.PRCSprBase);
	POKESAVESS_STREAM_8(MinxPRC.PRCMode);
	POKESAVESS_STREAM_8(MinxPRC.PRCRateMatch);
	POKESAVESS_STREAM_8(MinxPRC.PRCMapPX);
	POKESAVESS_STREAM_8(MinxPRC.PRCMapPY);
	POKESAVESS_STREAM_8(MinxPRC.PRCMapTW);
	POKESAVESS_STREAM_8(MinxPRC.PRCMapTH);
	POKESAVESS_STREAM_8(MinxPRC.PRCState);
	POKESAVESS_STREAM_X(13);
	POKESAVESS_END(1+32);
}
