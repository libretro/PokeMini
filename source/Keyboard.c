...
TUIMenu_Item UIItems_Keyboard[] = {
	{ 0,  0, "Go back...",       UIItems_KeyboardC, NULL },
	{ 0,  1, "Apply changes...", UIItems_KeyboardC, NULL },
	{ 0, 40, "Check inputs...",  UIItems_KeyboardC, NULL },
	{ 0,  4, "Menu Key: %s",     UIItems_KeyboardC, NULL },
	{ 0,  5, "A Key: %s",        UIItems_KeyboardC, NULL },
	{ 0,  6, "B Key: %s",        UIItems_KeyboardC, NULL },
	{ 0,  7, "C Key: %s",        UIItems_KeyboardC, NULL },
	{ 0,  8, "Up Key: %s",       UIItems_KeyboardC, NULL },
	{ 0,  9, "Down Key: %s",     UIItems_KeyboardC, NULL },
	{ 0, 10, "Left Key: %s",     UIItems_KeyboardC, NULL },
	{ 0, 11, "Right Key: %s",    UIItems_KeyboardC, NULL },
	{ 0, 12, "Power Key: %s",    UIItems_KeyboardC, NULL },
	{ 0, 13, "Shake Key: %s",    UIItems_KeyboardC, NULL },
	{ 0, 24, "Menu Alt: %s",     UIItems_KeyboardC, NULL },
	{ 0, 25, "A Alt: %s",        UIItems_KeyboardC, NULL },
	{ 0, 26, "B Alt: %s",        UIItems_KeyboardC, NULL },
	{ 0, 27, "C Alt: %s",        UIItems_KeyboardC, NULL },
	{ 0, 28, "Up Alt: %s",       UIItems_KeyboardC, NULL },
	{ 0, 29, "Down Alt: %s",     UIItems_KeyboardC, NULL },
	{ 0, 30, "Left Alt: %s",     UIItems_KeyboardC, NULL },
	{ 0, 31, "Right Alt: %s",    UIItems_KeyboardC, NULL },
	{ 0, 32, "Power Alt: %s",    UIItems_KeyboardC, NULL },
	{ 0, 33, "Shake Alt: %s",    UIItems_KeyboardC, NULL },
	{ 9,  0, "Keyboard",         UIItems_KeyboardC, NULL }
};
